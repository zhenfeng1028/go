...
type ChargeUnitMinuteLaneStat struct {
	Id              int64   `json:"id" xorm:"pk autoincr unique BIGINT"`
	Minute          int64   `json:"minute" xorm:"index(idx_20322_idx_minute_charge_unit) BIGINT"`
	ChargeUnit      string  `json:"charge_unit" xorm:"index(idx_20322_idx_minute_charge_unit) VARCHAR(255)"`
	Lane            int64   `json:"lane" xorm:"index BIGINT"`
