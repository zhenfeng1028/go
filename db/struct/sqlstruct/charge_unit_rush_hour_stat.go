...
type ChargeUnitRushHourStat struct {
	Id              int64   `json:"id" xorm:"pk autoincr unique BIGINT"`
	Day             int64   `json:"day" xorm:"index(idx_20346_idx_day_charge_unit_type) index(idx_20346_idx_day_type) BIGINT"`
	ChargeUnit      string  `json:"charge_unit" xorm:"index(idx_20346_idx_day_charge_unit_type) VARCHAR(255)"`
	Type            int64   `json:"type" xorm:"index(idx_20346_idx_day_charge_unit_type) index(idx_20346_idx_day_type) BIGINT"`
