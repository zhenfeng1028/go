...
func main() {
	...
	// var sql = "insert into person(id,name,age,address) values(1,'baijiaao',24,'Yuqiao') on duplicate key update age = values(age), address = values(address);"
